          ...
          <div className="headerCon jcsb">
            <div className="headerTitle">
              ...
              <div className="headerImg" onClick={()=>setBuyshow(!buyShow)}>
                <div style={{fontFamily:'PingFang SC'}}>BUY<DownOutlined style={{fontSize:'16px'}}/></div>
                {
                  buyShow ? (
            ...
            <div className="aic">
              <div className="headerIcon">
                ...
                <div >
                  <img className='icon1' style={{height:'60px',width:'28px'}} src={discord}/>
                </div>


              </div>
              <div className="headerMint" onClick={()=>Mint()}>
                MINT
              </div>
